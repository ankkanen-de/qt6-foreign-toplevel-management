...
class ForeignToplevelManagerV1Private
	...
	QMap<struct ::zwlr_foreign_toplevel_handle_v1 *,
...
class ForeignToplevelHandleV1Private
    ...
    protected:
	void
	zwlr_foreign_toplevel_handle_v1_app_id(const QString &appId) override;
	void
	zwlr_foreign_toplevel_handle_v1_title(const QString &title) override;
